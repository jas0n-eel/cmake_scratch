...
// configuration step. It creates a namespace called `cmake_scratch`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_scratch::cmake::project_name, cmake_scratch::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_scratch::cmake::project_version);
      return EXIT_SUCCESS;
    }
